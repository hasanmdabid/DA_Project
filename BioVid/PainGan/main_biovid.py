...
# This sript will train the conditional GAN model on BioVid datasets. The general instruction for the users are given below:
...
folder_path = './Data'
# dataset_name = input("Enter The name of the dataset(biovid or painmonit):")
dataset_name = 'biovid'
...
def define_discriminator(in_shape=(1408, 1, 1), n_classes=2):
    # label input
    ...
    li = Embedding(n_classes, 200, name='Discriminator-Label-Embedding-Layer')(in_label)  # Shape 1,50
...
plot_model(dis_model, show_shapes=True, show_layer_names=True, dpi=400, to_file='/home/abidhasan/Documents/PAINGAN/picture/discriminator_structure.png')
...
def define_generator(latent_dim, n_classes=2):
    ...
    n_nodes = 44 * 1  # To match the dimensions for concatenation later in this step.
    li = Dense(n_nodes, name='Generator-Label-Dense-Layer')(li)  # 1,64
    # reshape to additional channel
    li = Reshape((44, 1, 1), name='Generator-Label-Reshape-Layer')(li)
    ...
    n_nodes = 44 * 1 * 2  # This Part is very Important
    ...
    gen = Reshape((44, 1, 2), name='Generator-Foundation-Layer-Reshape-1')(gen)  # Shape=8x40x2
...
# Show model summary and plot model diagram
plot_model(gen_model, show_shapes=True, show_layer_names=True, dpi=400, to_file='/home/abidhasan/Documents/PAINGAN/picture/generator_structure.png')
