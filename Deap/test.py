...
combined_data_valence = np.append(X_val, y_val.reshape(valence.shape[0], 1), axis=1)
combined_data_arousal = np.append(X_aro, y_aro.reshape(arousal.shape[0], 1), axis=1)
...
combined_data_valence_slided, valence_slided = slided_numpy_array(combined_data_valence)
combined_data_arousal_slided, arousal_slided = slided_numpy_array(combined_data_arousal)
