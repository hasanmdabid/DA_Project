...
def data_pre_pro_with_scalling():
    ...
    path = '/home/abidhasan/Documents/DA_Project/Deap/cDEAPGAN/figures/'
    ...
    plt.savefig(save_picture_to + 'Valance_and_Arousal_between_groups.png', dpi = 500)
    ...
    axs[1, 1].boxplot([df_lalv['Valence'], df_lalv['Arousal']],
                      labels=['Valence', 'Arousal'])
    plt.savefig(save_picture_to+'Valence_and_arousal_rating_per_group.png', dpi=500)
    ...
    #print('Printing the 1st 10 valence labels:\n', df_valence.head(10))
    print('Counting the number of occurance of valence labels\n', df_valence.value_counts())
    ...
    print('Now the shape of total Valance labels:', valence.shape) # Labels (valence)
    ...
    print('After the concatination shape of eeg and valence', eeg_valence.shape)
    ...
    print('After the concatination shape of combined and valence', combined_data_valence.shape)
...
if __name__ == '__main__':
    try:
        ...
        combined_data_to_save = '/home/abidhasan/Documents/DA_Project/Deap/Data/pre_processed_np_data/combined'
        eeg_data_to_save = '/home/abidhasan/Documents/DA_Project/Deap/Data/pre_processed_np_data/eeg_only'
        valence_data = 'valence_data.npy'
        valence_label = 'valence_label.npy'
        arousal_data = 'arousal_data.npy'
        arousal_label = 'arousal_label.npy'

        # Combine folder path and file name
        combined_valence_data_full_path = f'{combined_data_to_save}/{valence_data}'
        combined_valence_labels_full_path = f'{combined_data_to_save}/{valence_label}'
        combined_arousal_data_full_path = f'{combined_data_to_save}/{arousal_data}'
        combined_arousal_labels_full_path = f'{combined_data_to_save}/{arousal_label}'

        # Save the NumPy array to the specified file
        import numpy as np
        np.save(combined_valence_data_full_path, combined_data_valence_slided)
        np.save(combined_valence_labels_full_path, combined_valence_slided)
        np.save(combined_arousal_data_full_path, combined_data_arousal_slided)
        np.save(combined_arousal_labels_full_path, combined_arousal_slided)
        
        # Combine folder path and file name
        eeg_valence_data_full_path = f'{eeg_data_to_save}/{valence_data}'
        eeg_valence_labels_full_path = f'{eeg_data_to_save}/{valence_label}'
        eeg_arousal_data_full_path = f'{eeg_data_to_save}/{arousal_data}'
        eeg_arousal_labels_full_path = f'{eeg_data_to_save}/{arousal_label}'

        # Save the NumPy array to the specified file
        import numpy as np
        np.save(eeg_valence_data_full_path, eeg_valence_slided)
        np.save(eeg_valence_labels_full_path, valence_slided)
        np.save(eeg_arousal_data_full_path, eeg_arousal_slided)
        np.save(eeg_arousal_labels_full_path, arousal_slided)       
