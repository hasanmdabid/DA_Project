def GAN_generator():
    ...
    n_samples = 1700                          #**** The number of samples value should be the factor of N_classes
    latent_dim = 100                           #*
    ...
    labels_har = asarray(
        [x for _ in range(1, 101) for x in range(1, 18)])  # Dimension of Labels should be same as N_samples. *****
